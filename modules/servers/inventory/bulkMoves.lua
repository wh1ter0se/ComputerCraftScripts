...
while true do
    ...
    move_all_by_types(crusher_output, storage_A1, {"minecraft:flint", "minecraft:clay_ball"})
    move_all_by_types(crusher_output, blaster_input, {"create:crushed_raw_iron", "create:crushed_raw_gold", "create:crushed_raw_copper", "create:crushed_raw_zinc", "minecraft:sand"})
